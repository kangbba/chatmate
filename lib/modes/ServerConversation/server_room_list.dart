...
import 'server_room_screen.dart';

class ServerRoomList extends StatefulWidget {
  const ServerRoomList({Key? key}) : super(key: key);

  @override
  State<ServerRoomList> createState() => _ServerRoomListState();
}

class _ServerRoomListState extends State<ServerRoomList>{
        ...
        child: ListTile(
          ...
          onTap: () async {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => ServerRoomScreen(chatRoomToLoad: chatRoom),
              ),
            );
          },
        ),
  ...
  void onPressedCreateChatRoomBtn() async{
    ...
    if (roomTitle != null && roomTitle.isNotEmpty) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ServerRoomScreen(
